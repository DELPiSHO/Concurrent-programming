...
void initializeDatabase()
{
    ...
    g_database[0].id = 0;
    strcpy(g_database[0].name, "CR7");
    g_database[1].id = 1;
    strcpy(g_database[1].name, "Pessi");
    g_database[2].id = 2;
    strcpy(g_database[2].name, "Penaldes");
    g_database[3].id = 3;
    strcpy(g_database[3].name, "AKINFENWA!!!111");
    g_database[4].id = 4;
    strcpy(g_database[4].name, "Pogbra");
    g_database[5].id = 5;
    strcpy(g_database[5].name, "MOHAMAD!!11 SALAH");
    g_database[6].id = 6;
    strcpy(g_database[6].name, "Benzino");
    g_database[7].id = 7;
    strcpy(g_database[7].name, "****** Ter Stegen");
    g_database[8].id = 8;
    strcpy(g_database[8].name, "Spalony Morata");
    g_database[9].id = 9;
    strcpy(g_database[9].name, "AGUEROOOOOOO");
    g_database[10].id = 10;
    strcpy(g_database[10].name, "sprzedaje miejsce w tej bazie danych za darmo!");
}
